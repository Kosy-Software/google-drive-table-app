            ...
            return new google.picker.PickerBuilder()
                    ...
                    .setCallback((data: any) => {
                        ...
                        if (data[google.picker.Response.ACTION] == google.picker.Action.PICKED) {
                            ...
                            let url = doc[google.picker.Document.URL]?.contains("/edit") ? doc[google.picker.Document.EMBEDDABLE_URL].replace("/preview", "/edit") : doc[google.picker.Document.EMBEDDABLE_URL];
                            //Notify the main app
